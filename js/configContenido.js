const contenidoConfig = {
    ...
    pelicula: {
        ...
        columns:[
            ...
            {field:"nombrePelicula", title:"Película", widthGrow:5, variableHeight: true, cssClass: "expandirCelda nombreTabla", headerTooltip: "Nombre de la película", formatter: cell => celdaNombre(cell)},
            {field:"directorPelicula", title:"Director", widthGrow:3, cssClass: "expandirCelda", headerTooltip: "Director de la película"},
            {field:"anoPelicula", title:"Año", width:70, headerTooltip: "Año de salida de la película"},
            {field:"fechaPelicula", title:"Visualización", width:120, headerTooltip: "Fecha de visualización", formatter: cell => cambiarFecha(cell.getValue())},
            {field:"ratingPelicula", title:"Valoración", width:110, headerTooltip: "Valoración personal de la película", formatter: cell => transformarRatingTabla(cell.getValue())},
            {field:"iconos", title:"", width:60, download:false, formatter: cell => celdaIconos(cell)}
        ]
    }, // Fin pelicula
    ...
    serie: {
        ...
        columns:[
            ...
            {field:"nombreSerie", title:"Serie", widthGrow:5, variableHeight: true, cssClass: "expandirCelda nombreTabla", headerTooltip: "Nombre de la serie", formatter: cell => celdaNombre(cell)},
            {field:"creadorSerie", title:"Creador", widthGrow:3, cssClass: "expandirCelda", headerTooltip: "Creador de la serie"},
            {field:"anoSerie", title:"Año", width:70, headerTooltip: "Año de salida de la serie"},
            {field:"fechaSerie", title:"Visualización", width:120, headerTooltip: "Fecha de visualización", formatter: cell => cambiarFecha(cell.getValue())},
            {field:"estadoSerie", title:"Estado", width:100, headerTooltip: "Estado personal de la serie"},
            {field:"ratingSerie", title:"Valoración", width:110, headerTooltip: "Valoración personal de la serie", formatter: cell => transformarRatingTabla(cell.getValue())},
            {field:"iconos", title:"", width:60, download:false, formatter: cell => celdaIconos(cell)}
        ]
    }, // Fin serie
    ...
    temporada: {
        ...
        columns:[
            ...
            {field:"nombreTemporada", title:"Temporada", widthGrow:5, variableHeight: true, cssClass: "expandirCelda nombreTabla", headerTooltip: "Nombre de la temporada", formatter: cell => celdaNombre(cell)},
            {field:"directorTemporada", title:"Director", widthGrow:3, cssClass: "expandirCelda", headerTooltip: "Director de la temporada"},
            {field:"anoTemporada", title:"Año", width:70, headerTooltip: "Año de salida de la temporada"},
            {field:"fechaTemporada", title:"Visualización", width:120, headerTooltip: "Fecha de visualización", formatter: cell => cambiarFecha(cell.getValue())},
            {field:"ratingTemporada", title:"Valoración", width:110, headerTooltip: "Valoración personal de la temporada", formatter: cell => transformarRatingTabla(cell.getValue())},
            {field:"iconos", title:"", width:60, download:false, formatter: cell => celdaIconos(cell)}
        ]
    }, // Fin temporada
    ...
    episodio: {
        ...
        columns:[
            ...
            {field:"nombreEpisodio", title:"Episodio", widthGrow:5, variableHeight: true, cssClass: "expandirCelda nombreTabla", headerTooltip: "Nombre del episodio", formatter: cell => celdaNombre(cell)},
            {field:"directorEpisodio", title:"Director", widthGrow:3, cssClass: "expandirCelda", headerTooltip: "Director del episodio"},
            {field:"anoEpisodio", title:"Año", width:70, headerTooltip: "Año de salida del episodio"},
            {field:"fechaEpisodio", title:"Visualización", width:120, headerTooltip: "Fecha de visualización", formatter: cell => cambiarFecha(cell.getValue())},
            {field:"ratingEpisodio", title:"Valoración", width:110, headerTooltip: "Valoración personal del episodio", formatter: cell => transformarRatingTabla(cell.getValue())},
            {field:"iconos", title:"", width:60, download:false, formatter: cell => celdaIconos(cell)}
        ]
    }, // Fin episodio
    ...
    juego: {
        ...
        columns:[
            ...
            {field:"nombreJuego", title:"Videojuego", widthGrow:5, variableHeight: true, cssClass: "expandirCelda nombreTabla", headerTooltip: "Nombre del videojuego", formatter: cell => celdaNombre(cell)},
            {field:"desarrolladorJuego", title:"Desarrollador", widthGrow:3, variableHeight: true, vertAlign:"middle", cssClass: "expandirCelda", headerTooltip: "Desarrollador del videojuego"},
            {field:"anoJuego", title:"Año", width:60, vertAlign:"middle", headerTooltip: "Año de salida del videojuego"},
            {field:"fechaInicioJuego", title:"Inicio", width:100, vertAlign:"middle", headerTooltip: "Fecha de inicio", formatter: cell => cambiarFecha(cell.getValue())},
            {field:"fechaJuego", title:"Finalización", width:110, vertAlign:"middle", headerTooltip: "Fecha de finalización", formatter: cell => cambiarFecha(cell.getValue())},
            {field:"plataformaJuego", title:"Plataforma", width:110, variableHeight: true, vertAlign:"middle", cssClass: "expandirCelda", headerTooltip:"Plataforma del videojuego"},
            {field:"ratingJuego", title:"Valoración", width:100, vertAlign:"middle", headerTooltip: "Valoración personal del videojuego", formatter: cell => transformarRatingTabla(cell.getValue())},
            {field:"iconos", title:"", width:50, vertAlign:"middle", download:false, formatter: cell => celdaIconos(cell)}
        ]
    ...
    libro: {
        ...
        columns:[
            ...
            {field:"nombreLibro", title:"Libro", widthGrow:5, variableHeight: true, cssClass: "expandirCelda nombreTabla", headerTooltip: "Nombre del libro", formatter: cell => celdaNombre(cell)},
            {field:"autorLibro", title:"Autor", widthGrow:3, variableHeight: true, vertAlign:"middle", cssClass: "expandirCelda", headerTooltip: "Desarrollador del libro"},
            {field:"anoLibro", title:"Año", width:60, vertAlign:"middle", headerTooltip: "Año de salida del libro"},
            {field:"fechaInicioLibro", title:"Inicio", width:100, vertAlign:"middle", headerTooltip: "Fecha de inicio", formatter: cell => cambiarFecha(cell.getValue())},
            {field:"fechaLibro", title:"Finalización", width:110, vertAlign:"middle", headerTooltip: "Fecha de finalización", formatter: cell => cambiarFecha(cell.getValue())},
            {field:"ratingLibro", title:"Valoración", width:100, vertAlign:"middle", headerTooltip: "Valoración personal del libro", formatter: cell => transformarRatingTabla(cell.getValue())},
            {field:"iconos", title:"", width:50, vertAlign:"middle", download:false, formatter: cell => celdaIconos(cell)}
        ]
